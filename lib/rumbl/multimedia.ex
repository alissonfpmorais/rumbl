defmodule Rumbl.Multimedia do
  ...
  @doc """
  Return the list of videos from a given user.

  ## Examples

      iex> list_user_videos(1)
      [%Video{}, ...]
  """
  ...
  Raises `Ecto.NoResultsError` if the User or Video does not exist.

  ## Examples

      iex> get_user_video!(1, 123)
      %Video{}
